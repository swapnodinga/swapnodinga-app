...
export default function ProfilePage() {
  ...
  const handlePhotoUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      // 2. Update the 'members' table (Matched to your DB schema)
      ...
      toast({ title: "Success", description: "Profile picture saved permanently." });
    } catch (error: any) {
      console.error("Sync Error:", error);
      toast({ variant: "destructive", title: "Sync Failed", description: "Check your database RLS policy." });
    } finally {
